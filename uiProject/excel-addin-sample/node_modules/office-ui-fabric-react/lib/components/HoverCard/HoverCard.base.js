...
var HoverCardBase = /** @class */ (function (_super) {
    ...
    function HoverCardBase(props) {
        ...
        _this._setEventListeners = function () {
            var _a = _this.props, trapFocus = _a.trapFocus, instantOpenOnClick = _a.instantOpenOnClick;
            var target = _this._getTargetElement();
    ...
    HoverCardBase.prototype.render = function () {
        ...
        var commonCardProps = tslib_1.__assign({}, getNativeProps(this.props, divProperties), { id: hoverCardId, trapFocus: !!trapFocus, firstFocus: setInitialFocus || openMode === OpenCardMode.hotKey, targetElement: this._getTargetElement(), onEnter: this._cardOpen, onLeave: this._childDismissEvent });
