...
var DetailsListGroupedLargeExample = /** @class */ (function (_super) {
    ...
    DetailsListGroupedLargeExample.prototype.render = function () {
        return (React.createElement(DetailsList, { items: this._items, groups: this._groups, columns: this._columns, ariaLabelForSelectAllCheckbox: "Toggle selection for all items", ariaLabelForSelectionColumn: "Toggle selection", checkButtonAriaLabel: "Row checkbox" }));
    };
