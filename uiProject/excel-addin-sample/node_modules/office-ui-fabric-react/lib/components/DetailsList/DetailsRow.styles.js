...
import { AnimationClassNames, AnimationStyles, FontSizes, HighContrastSelector, getFocusStyle, getGlobalClassNames, FontWeights } from '../../Styling';
...
// Constant values
var values = tslib_1.__assign({}, DEFAULT_ROW_HEIGHTS, { rowVerticalPadding: 11, compactRowVerticalPadding: 6 });
export var getStyles = function (props) {
    ...
    var _p = theme.palette, neutralPrimary = _p.neutralPrimary, white = _p.white, neutralSecondary = _p.neutralSecondary, neutralLighter = _p.neutralLighter, neutralLight = _p.neutralLight, neutralDark = _p.neutralDark, neutralQuaternaryAlt = _p.neutralQuaternaryAlt;
    ...
    var defaultCellStyles = [
        ...
        classNames.cell,
        {
            ...
            selectors: (_h = {
                ...
                _h[classNames.isFocusable] = getFocusStyle(theme, { inset: -1, borderColor: neutralSecondary, outlineColor: white }),
                _h)
        },
        isSelected && {
            selectors: (_j = {},
    ...
    return {
        root: [
            ...
            getFocusStyle(theme, { borderColor: focusBorder, outlineColor: white }),
            {
                ...
                textAlign: 'left',
                selectors: (_k = {},
                    _k["." + classNames.listCellFirstChild + " &:before"] = {
                        display: 'none'
                    },
                    _k['&:hover'] = {
                    ...
                    _k["." + IsFocusVisibleClassName + " &:focus $check"] = {
                        opacity: 1
                    },
                    _k)
            },
