define(["require", "exports", "tslib", "./Panel.types", "../../Styling", "../../Styling"], function (require, exports, tslib_1, Panel_types_1, Styling_1, Styling_2) {
    "use strict";
    ...
    var sharedPaddingStyles = {
        ...
        paddingRight: '16px',
        selectors: (_f = {},
            _f["@media screen and (min-width: " + Styling_1.ScreenWidthMinLarge + "px)"] = {
                paddingLeft: '32px',
                paddingRight: '32px'
            },
            _f["@media screen and (min-width: " + Styling_1.ScreenWidthMinXXLarge + "px)"] = {
                paddingLeft: '40px',
                paddingRight: '40px'
            },
            _f)
        ...
        return {
            ...
            headerText: [
                ...
                Styling_1.DefaultFontStyles.xLarge,
                {
                    ...
                    fontSize: 20,
                    fontWeight: Styling_2.FontWeights.semibold,
                    lineHeight: '27px',
                    margin: 0,
