define(["require", "exports", "../../Styling", "../../Utilities", "../../Styling"], function (require, exports, Styling_1, Utilities_1, Styling_2) {
    "use strict";
    ...
    exports.getStyles = Utilities_1.memoizeFunction(function (theme, customStyles) {
        ...
        var defaultStyles = {
            ...
            icon: {
                padding: '0 5px',
                fontSize: Styling_2.IconFontSizes.large
            },
            iconDisabled: {
            ...
            label: {
                ...
                lineHeight: Styling_2.IconFontSizes.large
            },
            labelDisabled: {},
            spinButtonWrapper: {
                display: 'flex',
