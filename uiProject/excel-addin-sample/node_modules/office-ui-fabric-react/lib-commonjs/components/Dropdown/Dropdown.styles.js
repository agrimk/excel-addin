...
exports.getStyles = function (props) {
    ...
    return {
        ...
        dropdown: [
            ...
            Styling_1.normalize,
            tslib_1.__assign({}, theme.fonts.medium, { color: palette.neutralPrimary, borderColor: palette.neutralSecondary, position: 'relative', outline: 0, userSelect: 'none', selectors: (_a = {},
        ...
        dropdownItemHeader: [
            ...
            tslib_1.__assign({}, theme.fonts.medium, { fontWeight: Styling_1.FontWeights.semibold, color: semanticColors.menuHeader, background: 'none', backgroundColor: 'transparent', border: 'none', height: DROPDOWN_ITEM_HEIGHT, lineHeight: DROPDOWN_ITEM_HEIGHT, cursor: 'default', padding: '0 8px', userSelect: 'none', textAlign: 'left' })
        ],
        subComponentStyles: {
